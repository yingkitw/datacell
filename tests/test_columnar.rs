...
fn test_read_parquet_sales_example() {
    ...
    let data = handler.read_with_headers("examples/sales.parquet").unwrap();
...
fn test_read_parquet_employees_example() {
    let handler = ParquetHandler::new();
    let data = handler.read_with_headers("examples/employees.parquet").unwrap();
...
fn test_read_parquet_numbers_example() {
    let handler = ParquetHandler::new();
    let data = handler.read_with_headers("examples/numbers.parquet").unwrap();
...
fn test_read_avro_sales_example() {
    ...
    let data = handler.read_with_headers("examples/sales.avro").unwrap();
...
fn test_read_avro_employees_example() {
    let handler = AvroHandler::new();
    let data = handler.read_with_headers("examples/employees.avro").unwrap();
...
fn test_read_avro_lookup_example() {
    let handler = AvroHandler::new();
    let data = handler.read_with_headers("examples/lookup.avro").unwrap();
