...
fn test_formula_addition() {
    ...
    evaluator.apply_to_csv(&input, &output, "A1+B1", "C1").unwrap();
...
fn test_formula_sum_column() {
    ...
    evaluator.apply_to_csv(&input, &output, "SUM(A1:A4)", "B1").unwrap();
...
fn test_formula_sum_row() {
    ...
    evaluator.apply_to_csv(&input, &output, "SUM(A1:E1)", "F1").unwrap();
...
fn test_formula_average_decimal() {
    ...
    evaluator.apply_to_csv(&input, &output, "AVERAGE(A1:A3)", "B1").unwrap();
...
fn test_formula_min_mixed() {
    ...
    evaluator.apply_to_csv(&input, &output, "MIN(A1:B3)", "C1").unwrap();
...
fn test_formula_max_mixed() {
    ...
    evaluator.apply_to_csv(&input, &output, "MAX(A1:B3)", "C1").unwrap();
...
fn test_formula_if_equal() {
    ...
    evaluator.apply_to_csv(&input, &output, "IF(A1=B1, 1, 0)", "C1").unwrap();
...
fn test_formula_if_less_than() {
    ...
    evaluator.apply_to_csv(&input, &output, "IF(A1<B1, 100, 0)", "C1").unwrap();
...
fn test_formula_sumif_greater() {
    ...
    evaluator.apply_to_csv(&input, &output, "SUMIF(A1:A4, \">10\")", "B1").unwrap();
...
fn test_formula_countif_equal() {
    ...
    evaluator.apply_to_csv(&input, &output, "COUNTIF(A1:A5, \"A\")", "B1").unwrap();
...
fn test_formula_concat_strings() {
    ...
    evaluator.apply_to_csv(&input, &output, "CONCAT(A1, \" \", B1)", "C1").unwrap();
...
fn test_formula_round_up() {
    ...
    evaluator.apply_to_csv(&input, &output, "ROUND(A1, 1)", "B1").unwrap();
...
fn test_formula_vlookup_first_row() {
    ...
    evaluator.apply_to_csv(&input, &output, "VLOOKUP(1, A1:C3, 3)", "D1").unwrap();
...
fn test_formula_vlookup_last_column() {
    ...
    evaluator.apply_to_csv(&input, &output, "VLOOKUP(2, A1:C3, 3)", "D1").unwrap();
...
fn test_formula_nested_arithmetic() {
    ...
    // (10 + 5) * 2 = 30
    evaluator.apply_to_csv(&input, &output, "(A1+B1)*C1", "D1").unwrap();
...
fn test_formula_with_constants() {
    ...
    // 10 * 2 + 5 = 25
    evaluator.apply_to_csv(&input, &output, "A1*2+5", "B1").unwrap();
