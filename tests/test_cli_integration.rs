...
/// Helper to get examples directory path
...
fn test_cli_convert_csv_to_parquet() {
    ...
    let input = examples_dir().join("numbers.csv");
...
fn test_cli_filter_operation() {
    let temp_dir = setup_temp_dir();
    let input = examples_dir().join("sales.csv");
...
fn test_cli_sort_operation() {
    let temp_dir = setup_temp_dir();
    let input = examples_dir().join("employees.csv");
...
fn test_cli_dedupe_operation() {
    let temp_dir = setup_temp_dir();
    let input = examples_dir().join("duplicates.csv");
...
fn test_validation_helpers() {
    use datacell::common::validation;
...
fn test_collection_utilities() {
    use datacell::common::collection;
