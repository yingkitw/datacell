...
impl ExcelHandler {
    ...
    pub fn apply_conditional_format_formula(
        ...
        false_format: Option<&super::types::CellStyle>,
        sheet_name: Option<&str>,
    ) -> Result<()> {
        ...
        anyhow::bail!("Conditional formatting requires reading existing workbook, which rust_xlsxwriter doesn't support. Use Excel's built-in conditional formatting after file creation.");
    }
