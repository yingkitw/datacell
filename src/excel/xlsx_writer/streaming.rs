...
mod tests {
    ...
    fn test_streaming_xlsx_basic() {
        let path = "test_streaming_basic.xlsx";
    ...
    fn test_streaming_xlsx_large() {
        let path = "test_streaming_large.xlsx";
    ...
    fn test_streaming_xlsx_write_row_data() {
        let path = "test_streaming_row_data.xlsx";
    ...
    fn test_streaming_xlsx_with_options() {
        ...
        let path = "test_streaming_options.xlsx";
    ...
    fn test_streaming_xlsx_empty() {
        let path = "test_streaming_empty.xlsx";
